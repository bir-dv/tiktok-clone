<template>
    <div id="PostMain" class="lg:-ml-[100px] flex border-b py-6">
        <div class="cursor-pointer">
            <img class="rounded-full max-h-[60px]" width="60" src="https://picsum.photos/id/237/300/300">
        </div>
        <div class="pl-3 w-full px-4 ">
            ...
            <div class="flex items-center font-semibold text-[14px] pb-0.5">
            ...
            <div class="mt-2.5 flex">
                <div
                    ...
                    <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full"
                        src="https://videos.pexels.com/video-files/8968858/8968858-uhd_1440_2732_24fps.mp4" />
                ...
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-4 ">
                        <div class="pb-4 text-center ">
                            <button class="rounded-full bg-gray-100 p-2 cursor-pointer">
                        ...
                        <div class="pb-4 text-center ">
                            ...
                            <span class="text-xs text-gray-800 font-semibold ">13</span>
